...
public class FirebaseDatabaseHelper {
    ...
    public FirebaseDatabaseHelper() {
        ...
        mReferenceBooks=mDatabase.getReference("books");//this retrieve all child of books table in database
    ...
    public void deleteBook(String key, final DataStatus dataSatus)
    {
        mReferenceBooks.child(key).setValue(null)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        dataSatus.DataIsDeleted();
